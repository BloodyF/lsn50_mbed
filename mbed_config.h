...
/*
#define RADIO_RESET_PIN                           PB_0
#define RADIO_NSS_PIN                             PA_15
#define RADIO_SCLK_PIN                            PA_5
#define RADIO_MISO_PIN                            PA_6
#define RADIO_MOSI_PIN                            PA_7
#define RADIO_DIO_0_PIN                           PC_13
#define RADIO_DIO_1_PIN                           PB_10
#define RADIO_DIO_2_PIN                           PB_11
#define RADIO_DIO_3_PIN                           PB_8
#define RADIO_DIO_4_PIN                           PB_9
#define RADIO_DIO_5_PIN                           PB_1
#define RADIO_ANT_SWITCH_PIN                      PA_8
#define BAT_LEVEL_PIN                             PA_4
*/

// Configuration parameters
#define CLOCK_SOURCE                                                          USE_PLL_HSI                                                                                        // set by target:DISCO_L072CZ_LRWAN1
#define LPTICKER_DELAY_TICKS                                                  3                                                                                                  // set by target:DISCO_L072CZ_LRWAN1
#define MBED_CONF_APP_LORA_ANT_SWITCH                                         PA_8                                                                                                 // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_CS                                                 PA_15                                                                                              // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO0                                               PC_13                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO1                                               PB_10                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO2                                               PB_11                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO3                                               PB_8                                                                                              // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO4                                               PB_9                                                                                                 // set by application[DISCO_L072CZ_LRWAN1]
#define MBED_CONF_APP_LORA_DIO5                                               PB_1                                                                                                 // set by application[DISCO_L072CZ_LRWAN1]
...
#define MBED_CONF_APP_LORA_RESET                                              PB_0                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
...
#define MBED_CONF_APP_LORA_SPI_SCLK                                           PA_5                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
